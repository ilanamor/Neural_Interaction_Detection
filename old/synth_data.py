...
def gen_synth_data():
    ...
    # X = pd.read_csv('datasets\X.csv', header=None).values
    # Y = pd.read_csv('datasets\Y.csv', header=None).values

    with open('datasets\X.pickle', 'rb') as handle:
        X= pickle.load(handle)

    with open('datasets\Y.pickle', 'rb') as handle:
